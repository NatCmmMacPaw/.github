...
- The type of issue (e.g., path traversal, unintended file deletion, privilege escalation)
- Full paths of source file(s) related to the manifestation of the issue. CleanMyMac CLI version (run `cleanmymac --version`) 
